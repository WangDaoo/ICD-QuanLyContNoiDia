/**
 * Web feature admin/partner-clients / CreatePartnerClientDialog.tsx
 *
 * Mục đích:
 * Khung file giao diện cho feature `admin/partner-clients`. Chưa có component/hook/API implementation.
 *
