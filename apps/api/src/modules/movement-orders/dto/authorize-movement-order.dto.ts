/**
 * movement-orders / authorize-movement-order.dto.ts
 *
 * Mục đích:
 * File dự kiến triển khai cho module movement-orders. Quản lý lệnh vận chuyển cho phép container di chuyển về ICD.
 *
 * Quy tắc khi triển khai:
 * - Ownership module: Movement Order lifecycle và authorization.
