...
import { CreateConsigneeDto } from '../dto/consignee/create-consignee.dto';

import { UpdateConsigneeDto } from '../dto/consignee/update-consignee.dto';
...
@Controller('admin/master-data/consignees')
export class ConsigneesController {
  constructor(private readonly service: ConsigneeService) {}
