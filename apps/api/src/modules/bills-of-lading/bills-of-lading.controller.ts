/**
 * bills-of-lading / bills-of-lading.controller.ts
 *
 * Mục đích:
 * File dự kiến triển khai cho module bills-of-lading. Quản lý Master B/L và House B/L, tránh nhầm với module Billing.
 *
 * Quy tắc khi triển khai:
 * - Ownership module: Vận đơn và liên kết document với container/consignee.
