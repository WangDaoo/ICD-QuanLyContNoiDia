...
import {
  USER_ERROR_CODES,
} from './constants/user-error-codes.constants';
...
export class UserService {
  ...
  private async getActiveRolesOrThrow(
  ...
  private assertNotSelf(
    ...
    if (
      ...
      throw new ConflictException({
        ...
        message:
          'Không thể thực hiện thao tác quản trị này trên chính tài khoản đang đăng nhập.',
      });
    }
  }
