/**
 * notifications / notification-dispatch.job.ts
 *
 * Mục đích:
 * File dự kiến triển khai cho module notifications. Điều phối Email/Push notification theo business event.
 *
 * Quy tắc khi triển khai:
 * - Ownership module: Notification delivery; không sở hữu state nghiệp vụ nguồn.
