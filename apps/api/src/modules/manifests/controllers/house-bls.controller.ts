...
@Controller(
  'manifests/:manifestId/master-bls/:mblId/house-bls',
)
export class HouseBlsController {
  constructor(
    private readonly houseBlService: HouseBlService,
  ) {}
  ...
  async list(
    ...
    return this.houseBlService.list(
      user.icdId,
      manifestId,
      mblId,
      query,
  ...
  async create(
    ...
    return this.houseBlService.create(
      user.icdId,
      manifestId,
      mblId,
      dto,
  ...
  async update(
    ...
    return this.houseBlService.update(
      user.icdId,
      manifestId,
      mblId,
      hblId,
  ...
  async remove(
    ...
    return this.houseBlService.remove(
      user.icdId,
      manifestId,
      mblId,
      hblId,
